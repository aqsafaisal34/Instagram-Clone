...
app.get("/profile", async (req, res) => {
    ...
    try {
        let allUser = await userModel.findOne({_id:req.body.token._id}).exec();
        res.send(user);
...
/////////////////////////////////////////////////////////////////////////////////////////////////
let dbURI = process.env.MONGODBURI || 'mongodb+srv://abc:abc@cluster0.iunhwh0.mongodb.net/instaData?retryWrites=true&w=majority';
